...
import { Card, Upload, Button, Input, message, Space, Spin, Typography } from 'antd';
import { UploadOutlined, FilterOutlined, CopyOutlined } from '@ant-design/icons';
        ...
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          <div>
            ...
            <Paragraph type="secondary">
              支持两种格式：JSON数组格式如 ["item1", "item2"] 或逗号分隔格式如 item1, item2, item3
            </Paragraph>
            <TextArea
              rows={6}
              placeholder={'["item_name", "brand", "color"] 或 item_name, brand, color'}
              value={items}
